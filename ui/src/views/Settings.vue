            ...
            <cv-text-input
              ...
              ref="host"
                          ...
                          import {
                            ...
                            TaskService,
                            IconService,
                            TextInput, // Add this import statement
              ...
              export default {
                ...
                methods: {
                  ...
                  getConfigurationAborted(taskResult) {
                    console.error(`get-configuration aborted`, taskResult);
                    this.error.getConfiguration = this.core.$t("error.generic_error");
                    this.loading.getConfiguration = false;
                  },
                  getConfigurationCompleted() {
                  ...
                  configureModuleAborted(taskResult) {
                    console.error(`configure-module aborted`, taskResult);
