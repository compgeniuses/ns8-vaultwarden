...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/library/redis:7 docker.io/library/postgres:15 docker.io/paperlessngx/paperless-ngx:2.2.0 ghcr.io/paperless-ngx/tika:latest docker.io/gotenberg/gotenberg:7.10" \
