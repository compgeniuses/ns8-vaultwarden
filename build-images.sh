...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/library/redis:7.2.3-bookworm docker.io/library/postgres:15.5-bookworm docker.io/paperlessngx/paperless-ngx:2.2.0 ghcr.io/paperless-ngx/tika:2.9.0-full docker.io/gotenberg/gotenberg:7.10.2" \
    --label="org.nethserver.tcp-ports-demand=1" \
    "${container}"
# Commit the image
